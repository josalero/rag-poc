...
2. [Ingestion Engine (Virtual Threads)](./ingestion-engine.md)
...
- Emphasis is on execution flow, data contracts, concurrency, and operational behavior.
- Diagrams are authoritative for component interaction.
- Code snippets are intentionally minimal; source-of-truth remains the implementation.
